...
async def clear_service_logs(
    ...
    try:
        ...
        logger.info(
            f'Successfully cleared logs for service {service!r} in container {container!r}'
        )
    except Exception as e:
...
async def control_service(
    ...
    try:
        ...
        agent_response = await client.control_service(
            service, request.action, request.launch_args, request.robot_type, request.navigation_type
        )
        logger.info(
